...
The `Interview Slots` tab seeds editable one-hour rows for `12:01 PM`, `3:00 PM`, `7:00 PM`, and `8:00 PM`. Only dated, active, non-full, future slots appear on the form.
